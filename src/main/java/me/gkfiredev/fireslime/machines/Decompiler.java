...
public class Decompiler extends SlimefunItem implements InventoryBlock, EnergyNetComponent {
    ...
    public Decompiler(ItemGroup category, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    protected void constructMenu(BlockMenuPreset preset) {
        ...
        for (int i : inputBorder) {
            preset.addItem(i, new CustomItemStack(new ItemStack(Material.LIGHT_BLUE_STAINED_GLASS_PANE), " "), (p, slot, item, action) -> false);
        }
